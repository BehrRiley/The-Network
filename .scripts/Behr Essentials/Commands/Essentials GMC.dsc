gmc_Command:
    ...
    adminpermission: Behr.Essentials.GMC.Others
    tab complete:
        - if <player.has_flag[Behr.Essentials.GMC.Others]>:
    ...
    # @ ██ [  Check User's Gamemode ] ██
        ...
        - else:
            - if <[User]> != <player>:
                - narrate "<proc[User_Display_Simple].context[<[User]>]> <proc[Colorize].context['s Gamemode changed to:|red]> <&e>Creative"
