Spawner_Command:
    ...
    script:
        - if <context.args.size> == 0 || <context.args.size> > 3:
            - inject Command_Syntax Instantly

        - define EntityList <server.list_material_types.filter[contains[spawn_egg]].parse[name.before[_spawn_egg]]>
        - define Type <context.args.get[1].to_titlecase>
